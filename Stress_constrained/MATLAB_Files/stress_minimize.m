...
% for i=1:nmp
%     x(i) = x(i)+0.01;
%     [pnorm,pnorm_sen,MISES,x]=Stress_Sensitivity_Comp(x,pl,q,p,B,D,carriers,Fd,kp,mpData,uvw,fint);
%     pnorm_sen(i) = pnorm_sen(i) - pnorm_sen_origin(i);
% end
